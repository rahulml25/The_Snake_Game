...
class Game:
    def __init__(self):
        ...
        self.surface = pygame.display.set_mode((self.display_wight, self.display_height))
    ...
    def render_background(self):
        ...
        bg = pygame.transform.scale(bg, (self.display_wight, self.display_height)).convert_alpha()
