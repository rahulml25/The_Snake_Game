...
class Snake:      
    ...
    def load_body(self):
        ...
        body = 'body.jpg'
        self.body = pygame.image.load(body_path+body).convert()
    ...
    def run(self):
        ...
        while running:
            ...
            # Defining Exception to
                ...
                self.setObjects() # Replaces the Snake 🐍 & Apple 🍎 on a random position again after Game is over
