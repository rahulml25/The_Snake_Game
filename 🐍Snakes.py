...
class Game:
    ...
    def welcome(self):
        ...
        font = pygame.font.SysFont(None, 90)
        wish_welcome = font.render(f"Welcome to Snakes",True,(255,0,0))
        self.surface.blit(wish_welcome,(70,300))
        font = pygame.font.SysFont('arial',35)
        cmd_run = font.render(f"Press Enter to Play Game",True,(250,250,250))
        self.surface.blit(cmd_run,(160,800))
        pygame.display.flip()
        while not start:
    ...
    def display_score(self):
        ...
        score = font.render(f"Score: {self.snake.score}  Highscore: {self.snake.highscore}",True,(200,200,200))
    ...
    def show_game_over(self):
        ...
        line2 = font.render(f"To play again press Enter. To exit press '0'!", True, (255, 255, 255))
        line3 = font.render(f'Your Score: {self.snake.score}', True, (255,255,255))
        line4 = font.render(f'High Score: {self.snake.highscore}', True, (255,255,255))
        self.surface.blit(line1, (50, 300))
        self.surface.blit(line2, (50, 400))
        self.surface.blit(line3, (50, 700))
        self.surface.blit(line4, (480, 700))
        pygame.display.flip()
