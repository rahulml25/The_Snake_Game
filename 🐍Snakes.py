...
class Game:
    ...
    def open_hiscore(self):
        if (not os.path.exists('resources/highscore')):
    ...
    def welcome(self):
        ...
        cmd_run = font.render(f"Press Enter to Play Game",True,(50,50,50))
        self.surface.blit(cmd_run,(140,800))
        pygame.display.flip()
        while not stop:
    ...
    def show_game_over(self):
        ...
        font = pygame.font.SysFont('arial', 30)
        line2 = font.render(f'Your score: {self.snake.score}', True, (255,255,255))
        line3 = font.render(f"To play again press Enter. To exit press '0'!", True, (255, 255, 255))
